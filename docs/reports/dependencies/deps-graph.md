...
flowchart LR
    subgraph src["src"]
        ...
        subgraph src/domain["/domain"]
            ...
            subgraph src/domain/services["/services"]
                ...
                src/domain/services/options//combiner.ts["options-combiner.ts"]
            end
        end
        ...
        subgraph src/application/use//cases["/application/use-cases"]
            ...
            src/application/use//cases/load//and//combine//config.ts["load-and-combine-config.ts"]
    ...
    src/application/use//cases/convert//files.ts-->src/domain/models/conversion.ts
    ...
    src/domain/services/options//combiner.ts-->node//modules/valibot/dist/index.d.cts
    ...
    src/application/use//cases/load//and//combine//config.ts-->src/domain/services/cli//options//parser.ts
    src/application/use//cases/load//and//combine//config.ts-->src/domain/services/options//combiner.ts
    ...
    src/presentation/cli.ts-->src/application/use//cases/load//and//combine//config.ts
